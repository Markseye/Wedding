...
const Marc = { name: "Marc Pierangeli",
							 ...
							 blurb: "Marc (a.k.a. \"P\") is one of Mark's oldest friends from high school. He spells his name differently (the wrong way), but we still let him hang out with us. He's a 'pop-in' pro, former O'Hara band member, and has the legendary hands of a masseur. He also works with my mom, which has helped alot when I need to get a hold of her at work and she turns her phone off. He's the first guy to hand you a beer and then stick around to talk your ear off about basically anything. He's also a loving father to his very cute daughter, Paige."}
