...
const Jaime = { title: "Maid Of Honor",
								...
								blurb: "Jaime is Katherine's Maid of Honor. They met during Katherine's sophomore year when she joined Alpha Phi at Villanova University and was matched with Jaime as the absolute best \"big\". Jaime has not only acted like Katherine's \"big sister\" but also as her best friend through the years - she even went as far as playing matchmaker by setting up Katherine and Mark as last-minute dates for a sorority function. It all came full circle when Jaime played a key role in Mark's proposal and was there to witness it all in Aruba - and helped everyone else witness their engagement by capturing the moment on camera."}
const Natalie = { name: "Natalie Monti",
									images: { formal: nat, funny: nat1 },
									blurb: "Natalie was one of Katherine's very first sorority friends (Fall '10), and the two of them clicked instantly. They also have shared strangely similar moves - moving out of Villanova into Manayunk, out of Manayunk into The Drake in Center City Philly, and moving to the Lower East Side of NYC (and then elsewhere in NYC) all around the same time - so the two have been inseparable for years. Natalie treats everyone she loves like her closest family, and Katherine and Mark have been no exception."}
const Allie = { name: "Allie Casparius",
								images: { formal: allie, funny: allie1},
								blurb: "Although the two often forget, Allie and Katherine didn't meet until senior year at Villanova. They both got job offers around the same time in the Philly area, so they decided to take a chance on each other and live together in Manayunk. It ended up being the best decision they could make, as they remained roommates throughout their time in Manayunk and moved in together at The Drake in Philly. The two often dreamed about working and living in NYC, so it was no surprise that when Allie got a job in NYC and Katherine did too soon after, they decided to become roommates once more and take on a whole new city together, and the two have become even closer with every move."}
const Casey = { name: "Casey Forman",
								images: {  formal: casey, funny: casey1},
								blurb: "Casey and Katherine met through Alpha Phi and as many do with Casey, became friends right away. Katherine and Casey became especially close senior year when Katherine became the 'house kat' at Casey's senior year house, finding a new bed on her futon for those late weekend (and weekday) nights. Through trips to Casey's lake house, visiting between Manayunk and Morristown, NJ, and now living nearby in NYC, the two have still hung out constantly on late weekend (and weekday) nights."}
const Kara = { name: "Kara O'Halloran",
							 images: {formal: kara, funny: kara1},
							 blurb: "Kara is one of Katherine's oldest Villanova friends. The two met freshman year at Villanova when they were living at St. Mo's right down the hall from each other and practically became unofficial roommates ever since, living together throughout Villanova and also as neighbors in Manayunk and Philly. Despite the distance that living in NYC and Philly has physically created, both Katherine and Kara continue to dedicate weekends to seeing each other and having their own versions of food and cocktail tours through each city. Hotel Kara (the.best.ever.) has also become Katherine's permanent residence whenever she visits Philly."}
...
const girls = { Jaime, Natalie, Allie, Casey, Kara, Marilyn, Bri, Olivia };
