...
import allie from "../../images/allie2.PNG";
import allie1 from "../../images/allie3.jpg";
...
import liv from "../../images/liv3.png";
import liv1 from "../../images/liv2.png";
...
const Natalie = { name: "Natalie Monti",
									...
									blurb: "Natalie was one of Katherine's very first sorority friends (Fall '10), and the two of them clicked instantly. They also have shared very similar life milestones - moving out of Villanova into Manayunk, out of Manayunk into The Drake in Center City Philly, and moving to the Lower East Side in NYC (and then elsewhere in NYC) all around the same time - so the two have been inseparable for years. They've even overlapped with their wedding planning! Natalie treats everyone she loves like her closest family, and Katherine and Mark have been no exception."}
...
const Casey = { name: "Casey Forman",
								...
								blurb: "Casey and Katherine met through Alpha Phi and as many do with Casey, they became friends right away. Katherine and Casey became especially close senior year when Katherine became the \"house kat\" at Casey's senior year house, finding a new bed on her futon for those late weekend (and weekday) nights. Through trips to Casey's lake house, visiting between cities, and now living nearby in NYC, the two have still hung out constantly on late weekend (and weekday) nights."}
